  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-10">
        <div>
          <button className=" py-1 px-16 my-4 border border-blue-900 text-blue-900 text-base font-medium rounded-md">
            Cancel
          </button>
        </div>
        <div>
          <button className="bg-blue-700 my-4 px-16 text-white font-medium py-1 rounded-md">
            Save
          </button>
        </div>
      </div>
